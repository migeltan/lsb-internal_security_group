...
$pageScript = BASE_URL . '/assets/js/access-pass.js';
...
<div class="mb-4">
    ...
    <h1 class="mb-1">Access Pass / ID Application</h1>
    <p class="text-muted">
...
<form id="accessPassForm" action="submit.php" method="POST" enctype="multipart/form-data" novalidate>
